# selenium-multiple-choice-skeleton
This should leverages OpenAI's API and Gemini's API through a unfied GUI to answer multiple choice questions in most websites. Has a plugin to dodge most low-medium level blockers for driver-based web browsers.
